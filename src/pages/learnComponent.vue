...
<script>
import NavBar from '../components/learnComponent/navbar.vue';
import Jumbotron from '../components/learnComponent/jumbotron.vue';
import Container from '../components/learnComponent/container.vue';
